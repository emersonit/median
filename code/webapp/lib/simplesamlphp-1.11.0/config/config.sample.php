...
$config = array (
	 ...
	 * reverse proxy).
	 */
	'baseurlpath'           => 'https://median.emerson.edu/simplesaml/', // !! edit this
	'certdir'               => 'cert/',
	'loggingdir'            => 'log/',
	'datadir'               => 'data/',
	 ...
	 */
	'auth.adminpassword'		=> 'xxx', // !! edit this
	...
	'technicalcontact_email'    => 'median@emerson.edu', // !! edit this
	 ...
	 */
	'timezone' => 'US/Eastern', // !! probably maybe edit this
	 ...
	 */
	'session.state.timeout' => (4*60*60), // 4 hours

	/*
	 * Option to override the default settings for the session cookie name
	 */
	'session.cookie.name' => 'M6SAML_SessID',
	 ...
	 */
	'session.cookie.lifetime' => 8 * (60*60), // 8 hours.
	 ...
	 */
	'session.cookie.domain' => '.emerson.edu', // !! edit this
	 ...
	 */
	'session.authtoken.cookiename' => 'M6SAML_AuthToken',
	 ...
	 * syntaxes.
	 */
	'store.sql.dsn' => 'mysql:host=your-auth-mysql.com;dbname=median_saml_db', // !! edit this

	/*
	 * The username and password to use when connecting to the database.
	 */
	'store.sql.username' => 'median_saml_usr', // !! edit this
	'store.sql.password' => 'xxx', // !! edit this
